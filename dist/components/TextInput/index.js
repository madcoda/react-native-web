...
var TextInput = (0, _NativeMethodsDecorator2.default)(_class = (_temp = _class2 = function (_Component) {
  ...
  _createClass(TextInput, [{
    ...
    value: function render() {
      ...
      var rootStyles = (0, _pick2.default)(style, viewStyleProps);
      var textStyles = (0, _omit2.default)(style, viewStyleProps);
      ...
      var propsCommon = {
        ...
        readOnly: !editable,
        style: _extends({}, styles.input, textStyles, { outline: style.outline }),
        value: value
      };
      ...
      var optionalPlaceholder = placeholder && this.state.showPlaceholder && _react2.default.createElement(
        _View2.default,
        { pointerEvents: 'none', style: styles.placeholder },
        _react2.default.createElement(_Text2.default, {
          children: placeholder,
          style: [styles.placeholderText, textStyles, placeholderTextColor && { color: placeholderTextColor }]
        })
      );
